...
public class ConversorMoeda extends AppCompatActivity {
    ...
    public void convertToDolar (View view){
        ...
        if(valorEmReal.equals("")){
            Toast.makeText(this, "Por favor, insira um valor para converter para Dolar", Toast.LENGTH_SHORT).show();
    ...
    public void convertToReal (View view){
        ...
        if(valorEmDolar.equals("")) {
            Toast.makeText(this, "Por favor, insira um valor para converter para Real", Toast.LENGTH_SHORT).show();
        } else {
